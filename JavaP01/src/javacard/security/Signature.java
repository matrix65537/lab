...
abstract public class Signature
{
    ...
    /**
     * Signature algorithm <code>ALG_DES_MAC_8_NOPAD</code> generates an
     ...
     * Note:
     * <ul>
     * <li><em>The <code>verify</code> method does not support the message recovery
     * semantics of this algorithm.</em>
     * </ul>
     */
     ...
     *                </ul>
     */
    abstract public short sign(byte[] inBuff, short inOffset, short inLength,
     ...
     *                </ul>
     */
    abstract public boolean verify(byte[] inBuff, short inOffset,
