 ...
 * {@link javacard.security.Signature#getInstance(byte, boolean) Signature.getInstance(byte, boolean)}
 * method when algorithm type with suffix <code>*_MR</code> is specified. e.g.{@link javacard.security.Signature#ALG_RSA_SHA_ISO9796_MR Signature.ALG_RSA_SHA_ISO9796_MR}.
 * <p>
