...
abstract public class Cipher
{
    ...
    /**
     * Cipher algorithm <code>ALG_RSA_ISO14888</code> provides a cipher using
     * RSA, and pads input data according to the ISO 14888 scheme.
     */
     ...
     * If the input data is not block aligned it throws
     * <code>CryptoException</code> with the reason code
     * <code>ILLEGAL_USE</code>.
     */
     ...
     *                </ul>
     */
    abstract public void init(Key theKey, byte theMode, byte[] bArray,
     ...
     *                input message length is not supported.
     *                </ul>
     */
    abstract public short update(byte[] inBuff, short inOffset, short inLength,
